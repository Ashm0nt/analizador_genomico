...
# --- Inicio del programa ---
ruta_input = "../data/secuencias.fasta"
ruta_output = "../results/resultados.tsv"

secuencias = leer_fasta(ruta_input)
...
if not secuencias:
    ...
    if resultados:
        exportar_tsv(resultados, ruta_output)
        print(f"[OK] Resultados guardados en: {ruta_output}")
    else:
